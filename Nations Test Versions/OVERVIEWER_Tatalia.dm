#modname "OVERVIEWER Tatalia" -- This will show on the mod menu ingame
#description "Edited up version of Tatalia to enable looking at units and spells and jazz" -- What shows when you look at the mod section of the game in detail
--#icon ".tga"
...
#level 0
#rarity 5
#homemon 6088 -- Greater Basilisk
#homemon 6089 -- Mighty Gorgon
#homemon 6091 -- Chaos Hydra
#homemon 6092 -- Colossal Hydra
#homemon 6093 -- Hell Hydra
#homecom 6090 -- Wyvern Monarch
