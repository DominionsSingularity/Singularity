...
#rarity 5
#req_pop0ok     
#req_targitem 602 -- Golem Control Rod
#msg "Commander Control Golem Takes Effect." 
#stealthcom 4199
#notext
#nolog
#end
	...
	#req_monster 4199
	#req_targmnr 4196
	#msg "Transform Golem into non-murdery." 
	#transform 4197 -- Non murdery Golem
	#notext
	#nolog
	#end
