...
[Ignore the stats and paths, they're just there to get the AI to treat this as an attractive hire. You don't need a lab to buy this.]"
#hp 10
#size 6
#mor 30
#mr 18
...
#magicskill 1 3
#magicskill 2 3
#magicskill 3 3 -- these paths are just to get the AI to recruit this
#nowish
#noreqlab
#end
...
#poisonres 75
#blind
#fixedname "SEEKING MAGES!"
#nohof
#custommagic 16256 200 -- everything but blood, this is here to tell the AI to recruit this and to make it requires a lab
#magicskill 0 2
#nowish
#end
...
----- Generic backstop event to remove Greater Contract
...
Economy: Master traders: 5% flat extra gold income and a further 20% extra in coastal forts.
